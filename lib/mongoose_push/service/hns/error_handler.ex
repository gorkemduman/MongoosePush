defmodule MongoosePush.Service.HNS.ErrorHandler do
  @moduledoc """
  Module responsible for handling errors returned by HNS service.
  """
  alias MongoosePush.Service

  # More information about possible return codes is here:
  # https://firebase.google.com/docs/reference/hns/rest/v1/ErrorCode

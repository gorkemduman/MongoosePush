defmodule MongoosePush.Service.HNS.Pool.Supervisor do
  @moduledoc """
  This module is responsible for setting up Sparrow's HNS Supervisor
  """
  use Supervisor, id: :hns_pool_supervisor
  require Logger
  alias MongoosePush.Application

  @default_endpoint "push-api.cloud.huawei.com"
  @default_port 443
  ...
  def init(pools_configs) do
    ...
    IO.inspect(sparrow_config)

    children = [
      Supervisor.child_spec({Sparrow.HNS.V1.Supervisor, sparrow_config},
        id: :hns_sparrow_supervisor
      )
    ]
